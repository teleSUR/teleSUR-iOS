...
#import "TSLargoViewController.h"
...
@implementation TSLargoViewController
...
- (void)viewDidLoad
{
    ...
    self.listado = [[TSClipListadoMenuProgranasViewController alloc] initWithNibName:@"TSIpadMenuProgramas" bundle:[NSBundle mainBundle]];     
